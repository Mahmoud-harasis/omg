...
edittrain = () => {
    ...
    document.getElementById("numbut").style.display = "block"
    document.getElementById("phone").style.display = "none"


    document.getElementById("emaill1").style.display = "block"
    document.getElementById("embut").style.display = "block"
    document.getElementById("email").style.display = "none"


    document.getElementById("text").style.display = "block"
    document.getElementById("txbut").style.display = "block"
...
savenum = () => {
    var phone1 = document.getElementById("phonee1").value
    localStorage.setItem("num", JSON.stringify(phone1))
    ...
    document.getElementById("numbut").style.display = "none"
}

document.getElementById("phone").innerHTML = JSON.parse(localStorage.getItem("num"))


saveem = () => {
    var email2 = document.getElementById("emaill1").value
    localStorage.setItem("em", JSON.stringify(email2))
    ...
    document.getElementById("embut").style.display = "none"
}

document.getElementById("email").innerHTML = JSON.parse(localStorage.getItem("em"))


savetx = () => {
    var text2 = document.getElementById("text").value
    localStorage.setItem("tx", JSON.stringify(text2))
    var tx = JSON.parse(localStorage.getItem("tx"))
    document.getElementById("profname").innerHTML = tx
    document.getElementById("profname").style.display = "block"
    document.getElementById("text").style.display = "none"
    document.getElementById("txbut").style.display = "none"
}

document.getElementById("profname").innerHTML = JSON.parse(localStorage.getItem("tx"))
